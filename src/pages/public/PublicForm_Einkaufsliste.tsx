...
async function submitPublicForm(fields: Record<string, unknown>) {
  const res = await fetch(`${KLAR_BASE}/public/69bd203533375c6b08d77858/69bd20171f363e8e32d0e8af/submit`, {
    method: 'POST',
...
export default function PublicFormEinkaufsliste() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Einkaufsliste — Formular</h1>
        </div>
